...
import org.aetas.dao.activity.CharacterLootActivityDao;
 ...
 */
@Repository
public class CharacterLootActivityJpaDao
        extends GenericCharacterActivityJpaDao<CharacterLootActivity> implements CharacterLootActivityDao {
    @Override
    protected Class<CharacterLootActivity> getPersistentClass() {
        return CharacterLootActivity.class;
    }
